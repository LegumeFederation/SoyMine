...
<html:html lang="true" xhtml="true">
    ...
    <body>
        <div align="center" id="headercontainer">
            ...
            <div id="header">
                <a href="${WEB_PROPERTIES['project.sitePrefix']}" alt="Home" rel="NOFOLLOW"><img id="logo" src="model/images/soybeans.png" width="45px" height="43px" alt="Logo" /></a>
                ...
                <p id="version"><fmt:message key="header.version"/><c:out value="${WEB_PROPERTIES['project.releaseVersion']}" escapeXml="false"/></span></p>
